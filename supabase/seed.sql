...
-- ============================================================================
-- NOTE: extraction_configs not seeded
-- ============================================================================
-- Extraction configs are generated dynamically by the AI ConfigGenerator
-- when new job sites are encountered. This allows the system to learn and
-- adapt to each site's unique structure.
